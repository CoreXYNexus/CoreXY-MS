...
//strikeY(screw5);
//strikeX(screw5,1); // second arg: 1 for exoslide
...
module mount(Screw=screw5) {
	difference() {
		...
		translate([8,26,-1]) color("blue") cylinder(h=Switch_thk*2,d=Screw);
	}
}
////////////////////////////////////////////////////////////////////////////////
...
//	difference() {
//		color("cyan") cuboid([13,HolderWidth,Switch_thk2],rounding=2,p1=[0,0]);
//		translate([8,6,-1]) color("red") cylinder(h=Switch_thk*2,d=Screw);
//		translate([0,0,0]) color("blue") hull() {
//			translate([7,26.5,-1]) color("blue") cylinder(h=Switch_thk*2,d=Screw);
...
module strikeY(Screw=screw5) {	// used on y a-xis
	difference() {
		color("cyan") cuboid([35,25,12],rounding=2,p1=[0,0]);
...
module strikeX(Screw=screw5,EXOSlide=0,DoTab=1) {	// used on y a-xis
	...
	if(EXOSlide) {
		color("gray") cuboid([35,5,27],rounding=2,p1=[0,0]);
		color("blue") hull() {
			translate([0,-10,22]) cuboid([35,15,5],rounding=2,p1=[0,0]);
			translate([0,0,13]) cuboid([35,5,5],rounding=2,p1=[0,0]);
		}
	} else color("gray") cuboid([35,10,9],rounding=2,p1=[0,0]);
	if(DoTab) {
