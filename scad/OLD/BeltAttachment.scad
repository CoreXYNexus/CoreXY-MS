...
// 10/31/20	- Fixed changes due to brassinserts.scad
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//=====================================================================================================
...
module XEndStopOnly(EndStopType=0,Side=0) {
	if(EndStopType==0) XEndStop(22,10,8,Yes3mmInsert(Use3mmInsert,LargeInsert),8,Side);
...
module CarriageMount() {
	rotate([180,0,0]) {
		difference() {
			...
			translate([-35,26,14.5]) color("red") rotate([0,90,0]) cylinder(h=130,d=Yes5mmInsert(Use5mmInsert));
...
module TopMountBeltHoles(Screw=Yes3mmInsert(Use3mmInsert,LargeInsert)) {
	...
	color("blue") hull() {
		...
		translate([28,0,0]) cylinder(h = 20, d = Screw);
	}
}
